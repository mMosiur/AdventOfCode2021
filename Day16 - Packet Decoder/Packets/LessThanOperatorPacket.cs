...
public class LessThanOperatorPacket : OperatorPacket
{
	public LessThanOperatorPacket(int version, int typeId, IReadOnlyCollection<Packet> subpackets) : base(version, typeId, subpackets)
	{
